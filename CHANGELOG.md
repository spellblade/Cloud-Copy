...
- New folder and Delete folder in both panes; delete confirms and sends the folder to MEGA/PikPak trash (#11)
...
[Unreleased]: https://github.com/spellblade/Cloud-Copy/compare/v1.0.5...HEAD
