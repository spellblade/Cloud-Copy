...
| 5 | F-001 + F-006 Credential file `0700`/`0600` (POSIX) and atomic write | No | `feat/dep-pins` |
| 6 | F-005 Sanitize remote names before local paths and transfer mkdir | No | `feat/safe-names` |
